            ...
            <div className={`${styles.inputContainer} ${extClassName?.containerClassName}`}>
                {label && (
                    <div className={styles.inputLabelContainer}>
                        {props.required && (
                            <span title="required">{requiredIcon}</span>
                        )}
                ...
                <div className={`${styles.inputWrapper } ${extClassName?.wrapperClassName}`}>
                    <input
                        ...
                        aria-invalid={!!error}
                        aria-describedby={
                            error ? `${inputId}-description` : undefined
                        }
                    />

                    {type === "password" && (
                        <button className={styles.hideButton} onClick={onHidden}>
                            {hidden ?
                                (<svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="20"
