...
const SelectOption: FC<SelectOptionProps> = ({name}) => {
    return ( 
        <li className={styles.selectBarOption}>
            <span className={styles.sboText}>{name}</span>
            <button className={styles.sboCloseBtn}>
